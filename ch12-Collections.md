...
그렇다면 namdtuples는 무엇 일까요? 튜플을 단순한 실행을 하기 편리한 컨테이너로 바꾸어줍니다. 네임 튜플을 사용하면 튜플 안의 값들에 접근하기 위해 정수 인덱스 값들을 사용할 필요가 없습니다. 사전형\(dictionaries\)과 비슷하다고 생각할 수도 있겠지만, 사전형과 달리 불변입니다.
